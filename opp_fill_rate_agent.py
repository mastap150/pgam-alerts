...
(Confirmed from platform: BidMachine 36,011,188 imps / 122,205,426,000 opps = 0.03%)
...
MIN_OPPS_FOR_SIGNAL  = 1_000_000  # opps threshold for diagnostic signal (platform scale)
TOP_N                = 10
    ...
    if alert:
        ...
        <div style="margin-top:28px;">
          ...
          <p style="font-size:12px;color:{GRAY_600};margin:0 0 20px 0;">
            Demand partners with ≥{fmt_num(MIN_OPPS_FOR_SIGNAL)} opportunities only.
